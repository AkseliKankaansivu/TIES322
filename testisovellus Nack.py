...
class VirtualSocket:
    ...
    def recvfrom(self, buffer_size):
        ...
        data, ack = self.verify_crc(data)
        
        return data, address, ack
...
class TestiSov:
    ...
    def run(self):
        ...
        while listening:
            try:
                rec, addr, ack = self.virtual_socket.recvfrom(256)
                print(rec.decode())
                if not ack:
                    self.virtual_socket.sendto("NACK", addr)
